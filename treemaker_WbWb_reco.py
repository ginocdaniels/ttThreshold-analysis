...
all_branches = [
    ...
    "jet1_R5_isD","jet2_R5_isD","jet3_R5_isD","jet4_R5_isD","jet5_R5_isD","jet6_R5_isD", "jets_R5_pflavor",                           
    "remaining_leptons_merged_size", "jets_R5_p_unfiltered_size","jets_R5_p_size","remaining_leptons_merged", "jets_R5_theta_unfiltered",
    ...
    "gen_leps_status1_fromW", "matched_fromW_leptons", "n_leps_d_iso_prompt_precut", "n_leps_d_iso_non_prompt_precut","n_leps_d_iso_all_precut_status1", "D_Iso_Values_all_status1","gen_leps_status1_mother_pdgId_non_prompt","gen_leps_status1_mother_pdgId_prompt", "ngen_leps_status1_from_b", "gen_leps_status1_from_b_pdgId","ngen_leps_status1_fromW",  "gen_leps_status1_pdgId", "muons_n", "electrons_n","tlv_from_b", "tlv_fromW", "size_gen_leps_status1_fromW", "size_gen_leps_status1_from_b",
    "combined_leptons_per_event","nlep_total", "gen_leps_status1_p_W","gen_leps_status1_from_b_p",
    "gen_leps_status1_from_b_muons_p","gen_leps_status1_fromW_muons_p", "gen_leps_status1_from_b_electrons_p","gen_leps_status1_fromW_electrons_p","matched_leps_status1_from_b_muons_p_cut_coneIso_2", "matched_leps_status1_from_b_muons_p_cut_coneIso_3", "matched_leps_status1_from_b_muons_p_cut_coneIso_4", "matched_leps_status1_from_b_muons_p_cut_coneIso_5", "matched_leps_status1_from_b_electrons_p_cut_coneIso_2", "matched_leps_status1_from_b_electrons_p_cut_coneIso_3", "matched_leps_status1_from_b_electrons_p_cut_coneIso_4",
     "matched_leps_status1_from_b_electrons_p_cut_coneIso_5",  "matched_leps_status1_from_W_muons_p_cut_coneIso_2", "matched_leps_status1_from_W_muons_p_cut_coneIso_3",
      ...
      "matched_leps_status1_from_W_electrons_p_cut_coneIso_5",
       "jets_R5_pflavor_unfiltered","masked_jet_constitutents","gen_leps_status1_fromW_vertex_xyz","gen_leps_status1_from_b_vertex_xyz",
      "bjets_R5_true","ljets_R5_true","remaining_muons_deltaR","remaining_electrons_deltaR","jets_R5_tlv","jets_R5_p","jets_R5_theta","remaining_leptons_p","remaining_muons_p","remaining_electrons_p",
      "jet_mother_pdg_id", "jet_daughter_stuff","E_RP_TRK_Z0_pcut", "electrons_iso", "muons_iso", "electrons_sel", "Mu_RP_TRK_Z0_pcut","muons_all_p", "electrons_all_p", "e_rp_trk_p", "W_boson_origin",
      "E_RP_TRK_Z0_pcut_iso_cut", "Mu_RP_TRK_Z0_pcut_iso_cut", "W_bosons_pdgId", "bjets_R5_WPp9", "bjets_R5_WPp8","bjets_R5_WPp5", "bjets_R5_WPp85","nbjets_R5_WPp5","nbjets_R5_WPp8","nbjets_R5_WPp85","nbjets_R5_WPp9", "bjets_R5_true_theta",
...
class RDFanalysis:
    ...
    # R5 clustering algorithm
        ...
        jetClusteringHelper_R5  = InclusiveJetClusteringHelper(
            collections_noleps["PFParticles"], 0.4, 5, "R5"
        )
        if  saveExclJets:
        ...
        df = df.Define("jets_R5_pflavor_unfiltered", "JetTaggingUtils::get_flavour({}, Particle)".format(jetClusteringHelper_R5.jets) )
        
        
        df = df.Define("jets_R5_p_unfiltered",           "JetClusteringUtils::get_p({})".format(jetClusteringHelper_R5.jets))
        df=df.Define("jets_R5_p_unfiltered_size", "jets_R5_p_unfiltered.size()")
        df = df.Define("jets_R5_theta_unfiltered",       "JetClusteringUtils::get_theta({})".format(jetClusteringHelper_R5.jets))
        df=df.Define("jets_R5_tlv_unfiltered",           "JetConstituentsUtils::compute_tlv_jets({})".format(jetClusteringHelper_R5.jets))
        ...
        df=df.Define("remaining_muons", "FCCAnalyses::ReconstructedParticle::get(Muon0, ReconstructedParticlesNoMuNoEl)")
        df=df.Define("remaining_electrons", "FCCAnalyses::ReconstructedParticle::get(Electron0, ReconstructedParticlesNoMuNoEl)")
        ...
        df = df.Define("remaining_muons_tlv", "FCCAnalyses::ReconstructedParticle::get_tlv(remaining_muons)")
        df = df.Define("remaining_electrons_tlv", "FCCAnalyses::ReconstructedParticle::get_tlv(remaining_electrons)")
        ...
        df=df.Define("remaining_leptons_merged", "FCCAnalyses::ReconstructedParticle::merge(remaining_muons, remaining_electrons)")
        df=df.Define("remaining_leptons_merged_size", "remaining_leptons_merged.size()")
        

        # Create a mask for jets based on proximity to leptons (muons and electrons)
        # We will mark jets for removal if they are too close to any lepton (Delta R < threshold)
            # Set the Delta R threshold for jet removal
        ...
        ## Attempt to mother match the jets
        ...
        df=df.Define("jets_R5_tlv", "jets_R5_tlv_unfiltered[jet_removal_mask]")
        df=df.Define("jets_R5_p", "jets_R5_p_unfiltered[jet_removal_mask]")
        df=df.Define("jets_R5_p_size", "jets_R5_p.size()")
        df=df.Define("jets_R5_theta", "jets_R5_theta_unfiltered[jet_removal_mask]")
        ...
        df = df.Define("ncjets_R5_true", "return int(jets_R5_ctagged_true.size())")
        df = df.Define("nljets_R5_true", "return int(jets_R5_ltagged_true.size())")
        df = df.Define("ngjets_R5_true", "return int(jets_R5_gtagged_true.size())")


        df = df.Define("bjets_R5_true",  "JetConstituentsUtils::compute_tlv_jets({})". format('jets_R5_btagged_true'))
        df=df.Define("bjets_R5_true_theta","JetClusteringUtils::get_theta({})".format('bjets_R5_true'))

        df=df.Define("cjets_R5_true",  "JetConstituentsUtils::compute_tlv_jets({})". format('jets_R5_ctagged_true'))
        df=df.Define("cjets_R5_true_theta","JetClusteringUtils::get_theta({})".format('cjets_R5_true'))
        df=df.Define("ljets_R5_true",  "JetConstituentsUtils::compute_tlv_jets({})". format('jets_R5_ltagged_true'))
        df=df.Define("ljets_R5_true_theta","JetClusteringUtils::get_theta({})".format('ljets_R5_true'))
        df=df.Define("gjets_R5_true",  "JetConstituentsUtils::compute_tlv_jets({})". format('jets_R5_gtagged_true'))
        df=df.Define("gjets_R5_true_theta","JetClusteringUtils::get_theta({})".format('gjets_R5_true'))


        #Here is where maybe u can find the B that the quark is coming from and then use that to find the parent quark to see if from top
        df = df.Define("ljets_R5_true",  "JetConstituentsUtils::compute_tlv_jets({})". format('jets_R5_ltagged_true'))
    ...
    # df_return=function_to_run(df,0.5)
    # df_return=function_to_run(df0)
    # df_return=function_to_run(df1)
    # df_return=function_to_run(df2)
