...
all_branches = [
    "njets_R5","jets_R5_pflavor", "jets_R5_p_unfiltered_size","jets_R5_p_size", "jets_R5_theta_unfiltered",
      ...
      "bjets_R5_true_pt", "bjets_R5_true_m", "jets_R5_pt", "jets_R5_m", "jets_R5_e","Z_collection_1","pt_zcollection_1","Z_collection_1_sim_status","Z_collection_1_gen_status", 
      "Z_collection_1_status22","Z1_22_daughter1","Z1_22_daughter_test","all_pdgs",
...
class RDFanalysis:
    ...
    def analysers(df):
        ...
        # df=df.Filter("Z_daughter_2_pdg_abs_is_neutrino || Z_daughter_2_pdg_abs_is_quark")
