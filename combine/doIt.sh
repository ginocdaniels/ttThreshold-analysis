...
do
    ...
    do
	for var in njets_R5  nbjets_R5_eff_p9 jet1_R5_p jet2_R5_p jet1_R5_theta jet2_R5_theta  jet3_R5_p jet3_R5_theta jet4_R5_p jet4_R5_theta nbjets_R5_true njets_R5 lep_p lep_theta
	do
	    ...
	    python plotter_v1.py  -i --logy --vname ${var} --sel no_cut -p  -c ${channel} -e ${ecm} --nostack
	    python plotter_v1.py  -i --logy --vname ${var} --sel zerob  -p  -c ${channel} -e ${ecm} --nostack
	    python plotter_v1.py  -i --logy --vname ${var} --sel twob  -p  -c ${channel} -e ${ecm} --nostack
	    python plotter_v1.py  -i --logy --vname ${var} --sel oneb  -p  -c ${channel} -e ${ecm} --nostack
	done
    done	
done 
